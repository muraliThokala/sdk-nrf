...
/** @file
 * @brief Coexistence Manager test bench configuration (SR SW client variant).
 *
 ...
 *
 * Includes CD2CM_SR_SW_CLIENT_REQUEST / CM2CD_SR_SW_CLIENT_STATUS_EVENT via
...
#define COEX_TB_TEST_SR_SW_CLIENT_REQUEST
#define COEX_TB_NUM_SR_SW_CLIENT_TESTS   1U
