...
The following table provide the procedure to run Wi-Fi-only, Thread-only, and combined throughput.
...
|               |              | Do the following as described under "Supported CLI commands"   |
|               |              | section.                                                       |
|               |              | Thread throughput configuration at peer with Thread role set to|
...
|               |              | Do the following as described under "Supported CLI commands"   |
|               |              | section.                                                       |
|               |              | Thread throughput configuration at peer with role set to server|
...
Test procedure is like the Wi-Fi client and Thread client described above except that the thread role set to server at DUT and client at peer.
