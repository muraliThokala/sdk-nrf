...
enum nrf_wifi_status nrf_wifi_fmac_conf_gpio_ctrl_sr_coex(struct nrf_wifi_fmac_dev_ctx *fmac_dev_ctx,
                                               unsigned int alt_swctrl1,
											   unsigned int invert_bt_coex_grant)
{
    enum nrf_wifi_status status = NRF_WIFI_STATUS_FAIL;
