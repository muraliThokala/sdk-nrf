...
/**
 * @brief Configure coexistence GPIOs in GPIO control register in RPU.
 * @param fmac_dev_ctx Pointer to the UMAC IF context for a RPU WLAN device.
 * @param Select SWCTRL1 alternative function.
 * @param Invert Bluetooth LE coex grant polarity.
 *
 * This function is used to control the coexistence GPIOs
 *
