...
/**
 * @function   nrf_wifi_coex_config_non_pta(bool separate_antennas, bool is_sr_protocol_ble,
 ...
 * @param[in]  is_sr_protocol_ble
 *             Indicates if SR protocol is Bluetooth LE or not.
 * @param[in]  is_ch_enable
 *             Indicates whether CH is to be enabled or not.
 * @param[in]  is_rf_switch_to_wifi
 *             Indicates whether WLAN side RF switch is to be connected to WLAN by default or not.
 *
 * @return     Returns status of configuration.
 *             Returns zero upon successful configuration.
 *             Returns non-zero upon unsuccessful configuration.
