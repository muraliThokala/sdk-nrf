...
/** @file
 * @brief Public coexistence driver APIs (SR SW client variant).
 *
 ...
 * CD2CM_SR_SW_CLIENT_REQUEST CM2CD_SR_SW_CLIENT_STATUS_EVENT
 * CD2CM_GET_STATS            CM2CD_STATISTICS_EVENT
 *
 * SR software client requests use coex_cd_sr_software_client_request() from
 * nrf71_cd_sr_if.h (CD2CM_SR_SW_CLIENT_REQUEST /
