...
/** @file
 * @brief SR SW client patch definitions used by the SR client driver variant.
 *
 * Matches @c cm_fsm_patch_stats.h from the ROM 1.0 SR SW client firmware patch.
 */

#ifndef NRF71_SR_COEX_SR_PATCH_IF_H__
#define NRF71_SR_COEX_SR_PATCH_IF_H__
 ...
 *
 * Appended after cm_stats_t in CM2CD_STATISTICS_EVENT payloads when the
...
#endif /* NRF71_SR_COEX_SR_PATCH_IF_H__ */
